            ...
            <div class="row pt-5">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 p-0">
                    <div class="form-group row">
                        <label for="example-text-input" class="col-3 col-form-label">Name</label>
                        <div class="col-9">
                            <input disabled="" class="form-control form-check" type="text" value="{{ Auth::user()->name }}" name="name" required="" id="example-text-input">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-search-input" class="col-3 col-form-label">Email Adress</label>
                        <div class="col-9">
                            <input disabled="" class="form-control" type="email" value="{{ Auth::user()->email }}" name="email" required="" id="example-search-input">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-search-input" class="col-3 col-form-label">Adress</label>
                        <div class="col-9">
                            <input disabled="" class="form-control" type="text" value="{{ Auth::user()->address }}" name="address" required="" id="example-search-input">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-search-input" class="col-3 col-form-label">Phone</label>
                        <div class="col-9">
                            <input disabled="" class="form-control" type="number" value="{{ Auth::user()->phone }}" name="phone" required="" id="example-search-input">
                        </div>
                    </div>
                </div>
                @endif
                            ...
                            <p class="card-text">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="total">${{number_format($totalPrice)}}</td>
                                        <tr>
